      ...
      <div className="fixed top-0 left-0 right-0 z-50">
        <div className="flex justify-between items-start pt-4 pb-2 px-4">
          ...
          <div className="flex gap-2 bg-black/20 backdrop-blur-sm rounded-lg border border-white/20 p-2">
            ...
            <Link 
              href="/writing"
              className="px-4 py-2 rounded-md text-white font-semibold text-sm transition-all duration-300 hover:scale-105 relative overflow-hidden bg-amber-600/50"
              style={{
      ...
      <div className="relative z-10 container mx-auto px-4 pt-24">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-white/80 max-w-2xl mx-auto">
            Creative writing, technical documentation, and storytelling
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-lg border border-white/20 p-6 hover:bg-white/20 transition-all duration-300">
            ...
            <h3 className="text-xl font-semibold text-white mb-2">Sample Writing Project</h3>
            <p className="text-white/70 mb-4">
              A creative piece exploring themes of technology and human connection.
            </p>
            <div className="flex gap-2">
              <span className="px-3 py-1 bg-amber-500/20 text-amber-300 rounded-full text-sm">Creative</span>
              <span className="px-3 py-1 bg-yellow-500/20 text-yellow-300 rounded-full text-sm">Fiction</span>
            </div>
          </div>

          {/* Add more writing projects here */}
        </div>
      </div>
    </main>
  )
